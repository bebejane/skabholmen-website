...
export const GRAPHQL_API_ENDPOINT = process.env.GRAPHQL_API_ENDPOINT || `https://graphql.datocms.com`;
export const GRAPHQL_PREVIEW_API_ENDPOINT = process.env.GRAPHQL_PREVIEW_API_ENDPOINT || `https://graphql.datocms.com/preview`;
